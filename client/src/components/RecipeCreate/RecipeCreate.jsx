...
function RecipeCreate() {
  ...
  function handleSubmit(e) {
    ...
    if (input.healthscore > 100 || input.healthscore < 0) {
      return alert(
        "El valor del Health Score tiene que ser de 0 a 100. Ingrese uno válido"
      );
    }
              ...
              {diets.map((e) => {
                return (
                  <div className="organizadorcheck">
                    <p className="textcheck">{e.name}</p>
                    <input
                      className="checkdietas"
                      type="checkbox"
                      name={e.name}
                      value={e.name}
        ...
        <section className="stepyrender">
          <div className="stepbystep">
            ...
            <textarea
              value={dataSteps}
              name="name"
              onChange={(e) => setDataSteps(e.target.value)}
              row="8"
              col="80"
            ></textarea>
            <div>
              <input
                ...
                name="agregar"
                value="Agregar paso"
                onClick={(e) => handlerAddSteps(e)}
              ></input>
              <input
                type="submit"
                name="borrar"
                value="Borrar último"
                onClick={(e) => handlerDeleteLast(e)}
              ></input>
              <input
                type="submit"
                name="borrartodo"
